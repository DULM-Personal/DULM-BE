...
class JwtTokenProvider(
    ...
    fun createAccessToken(email: String): String = createToken(email, jwtProperties.accessExp)

    fun createRefreshToken(email: String): String = createToken(email, jwtProperties.refreshExp)
